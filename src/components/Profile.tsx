...
export default function Profile({ data }: any) {
  ...
  const currentExperience = data?.experience && data.experience.length > 0 
    ? data.experience[data.experience.length - 1] 
    : null;

  return (
    <div className="flex flex-col md:flex-row items-start md:items-center gap-6 md:gap-8 py-8 md:py-12">
      {/* Profile Image */}
